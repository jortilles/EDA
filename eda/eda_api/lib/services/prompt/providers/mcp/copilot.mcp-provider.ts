...
export class CopilotMCPProvider implements IMCPAIProvider {
...
/*
Config que necesita el proveedor (en el objeto que llega a la factory):
{
  "PROVIDER": "copilot",
  "API_KEY": "tu-azure-api-key",
  "RESOURCE_NAME": "mi-recurso-azure",
