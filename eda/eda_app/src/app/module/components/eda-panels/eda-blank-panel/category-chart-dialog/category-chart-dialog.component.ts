...
const CHART_TYPE_SPECS: Record<CategoryChartType, ChartTypeSpec> = {
  ...
  bubblechart:  { chartType: 'bubblechart',  colorEditorShape: 'category-list', hasUseGradient: true,  hasInnerRadius: false, hasTopNCount: false, hasTransitionMs: false, hasIcons: true,  toggles: ['chartLegend', 'useIcons'] },
