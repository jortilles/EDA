...
export class EdaDoughnut implements OnInit, AfterViewInit, OnDestroy {
  ...
  private updateLegendSizing(): void {
    ...
    // Chart.js hardcodes the doughnut/polarArea legend label font to 14px (legendLabelsFont in
    // chart-utils.service.ts) regardless of manySeries/variador - only boxWidth/padding scale.
